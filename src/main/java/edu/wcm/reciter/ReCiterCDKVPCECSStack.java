...
public class ReCiterCDKVPCECSStack extends NestedStack {

    private final ApplicationLoadBalancer reCiterEcsALB;
    
    public ReCiterCDKVPCECSStack(final Construct parent, final String id) {
        this(parent, id, null, null);
    }

    public ReCiterCDKVPCECSStack(final Construct parent, final String id, final NestedStackProps props, IVpc vpc) {
        ...
        ContainerDefinition reCiterPubmedContainer = reCiterTaskDefinition.addContainer("reCiterPubmedContainer", ContainerDefinitionProps.builder()
            .image(ContainerImage.fromRegistry("httpd:2.4"))
            .logging(new AwsLogDriver(AwsLogDriverProps.builder()
        ...
        final FargateTaskDefinition reCiterPubManagerTaskDefinition = new FargateTaskDefinition(this, "reCiterScopusTaskDefinition", FargateTaskDefinitionProps.builder()
            .cpu(1024)
            .memoryLimitMiB(2048)
            .build());
        ...
        ContainerDefinition reCiterPubManagerContainer = reCiterPubManagerTaskDefinition.addContainer("reCiterScopusContainer", ContainerDefinitionProps.builder()
            ...
            .healthCheck(HealthCheck.builder()
                .command(Arrays.asList("CMD-SHELL", "curl -f http://localhost:5000/login || exit 1"))
                .interval(Duration.minutes(5))
                .retries(2)
                .startPeriod(Duration.seconds(60))
                .timeout(Duration.seconds(30))
        ...
        ScalableTaskCount reCiterPubManagerAutoScaling =  reCiterScopusService.autoScaleTaskCount(EnableScalingProps.builder()
            .minCapacity(1)
            .maxCapacity(2)
            .build());
        ...
        //Create a SNS Topic
        Topic reciterAlarmTopic = new Topic(this, "vivoSnsTopic", TopicProps.builder()
            .topicName("vivo-monitor-topic")
            .displayName("vivo-monitor-topic")
            .build());
        ...
        Tags.of(this).add("stack-id", ReCiterCDKVPCECSStack.of(this).getStackId());
        Tags.of(this).add("stack-name", ReCiterCDKVPCECSStack.of(this).getStackName());
        Tags.of(this).add("stack-region", ReCiterCDKVPCECSStack.of(this).getRegion());
    }
}
